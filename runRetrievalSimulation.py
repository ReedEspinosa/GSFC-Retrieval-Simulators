...
#     nAng = int(sys.argv[2])
    ...
    saveStart = os.path.join(basePath, 'synced/AOS/Phase-A/PLRA_RequirementsAndTraceability/GSFC_ValidationSimulationsData/V0/Run-21_')
...
τFactor = ['randLogNrm0.1','randLogNrm0.3'] #1 - Syntax error on this line? Make sure you are running Python 3!
