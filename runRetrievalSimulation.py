...
if checkDiscover(): # DISCOVER
    ...
    saveStart = os.path.join(basePath, 'synced/AOS/Pre-Phase-A/Polarimeter_Simulations/V2/V2')
...
conCases = ['pollutionVariable+smokeVariableLand']
τFactor = ['randLogNrm5.0'] #1 - Syntax error on this line? Make sure you are running Python 3!
