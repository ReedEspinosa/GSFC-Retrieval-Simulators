...
# Calculate exactly which month and day this task_id represents
month_index = task_id // days_per_month
month = target_months[month_index]

# Calculate the day (remainder of the division) and add 1 because days are 1-indexed
day = (task_id % days_per_month) + 1  
...
# =========================================================================
print(f"\n=======================================================")
print(f"Starting OSSE Daily Processing for: {year:04d}-{month:02d}-{day:02d} (Task ID: {task_id})")
print(f"=======================================================")

# Loop over all 24 hours in the calculated day
for hour in range(24):
    print(f"\n--- Processing Hour: {hour:02d}:00Z ---")
    try:
...
print(f"\nCompleted Day: {year:04d}-{month:02d}-{day:02d}")
