...
binGRASP = '../../GRASP_GSFC/build_megaharp01/bin/grasp'
...
conCase = 'dark_ocean_coarse_campex_bi_flatfine_flatcoarse_flight#01_layer#00' # conanical case scene to run, case06a-k should work (see all defintions in setupConCaseYAML function)
